...
function inningsLine(team: CricketTeam | undefined, innings: CricketInnings | undefined, index: number): string {
...
function printFixtures(data: CricketResponse, ymd: string): void {
...
async function fetchTodayCricket(ymd: string): Promise<CricketResponse> {
  const url =
